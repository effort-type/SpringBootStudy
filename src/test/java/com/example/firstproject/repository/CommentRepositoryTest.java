...
class CommentRepositoryTest {
    ...
    @Test
    @DisplayName("특정 게시글의 모든 댓글 조회") // 테스트 메서드 이름을 변경하지 않고 하는 방법
    void findByArticleId() {
        /* Case 1: 4번 게시글의 모든 댓글 조회 */
        {
            ...
            Comment c = new Comment(3L, article, "Jung", "쇼생크 탈출");
    ...
    void findByNickname() {
        ...
        /* Case 4: ""의 모든 댓글 조회 */
        {
            ...
            // 검증
            assertEquals(expected.toString(), comments.toString(), "공백의 댓글은 없음.");
        }
        ...
        /* Case 5: "i"의 모든 댓글 조회 */
        {
            ...
            // 검증
            assertEquals(expected.toString(), comments.toString(), "i의 댓글은 없음");
        }
    }
}